...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        kawaii: "0 10px 40px -10px hsl(var(--primary) / 0.4), 0 4px 20px -5px hsl(var(--secondary) / 0.3)",
        "kawaii-lg": "0 15px 50px -10px hsl(var(--primary) / 0.5), 0 8px 30px -5px hsl(var(--secondary) / 0.4)",
      },
    },
  },
